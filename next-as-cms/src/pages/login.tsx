        ...
        <div className="flex rounded-lg border px-12 py-6  shadow-md">
          ...
          >
            ...
            >
              <div className="flex">
                <div><Input></Input></div>
                <div className="identifying-img border w-40 ml-2">
            ...
            <Form.Item wrapperCol={{ span: 22 }}>
              <div className="flex justify-center">
                <Button type="primary" htmlType="submit" className="w-1/5">
                  登录
                </Button>
                <Button type="default" onClick={onRegister}  className="w-1/5 ml-5">
                  注册
                </Button>
              </div>
            </Form.Item>
